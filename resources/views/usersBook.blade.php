...
<div class='container'>
    <div class="card my-4">  
    @auth
    <div class="title"> <h3>Twoje książki</h3></div>
    <table data-toggle="table">
        ...
        @foreach($library as $book)
            <tr>
                ...
                <td>{{$book->status}}</td>
                <td><a href="{{ route('renew',$book->id) }}" class="btn btn-success btn-xs" onclick="return confirm('Przedłużyć termin wypożyczenia książki?')" title="przedluz"> Przedłuż </a></td>   
                <td><a href="{{ route('return',$book->id) }}" class="btn btn-danger btn-xs" onclick="return confirm('Jesteś pewien, że chcesz oddać książkę?')" title="Oddaj">
                <i class="fa fa-trash-o"></i> Oddaj książkę </a></td>
            </tr>
            @endforeach
