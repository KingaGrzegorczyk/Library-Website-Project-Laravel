...
<nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
    ...
    <div class='container'>
        ...
        @auth
        <div class="card my-4">
            <h5 class="card-header">Wyszukaj książkę</h5>
            <div class="card-body">
            <form role="form" action="/search" method="get"> 
            <div class="form-group">
                {{csrf_field()}}
                    <input type="search" name="search" class="form-control" placeholder="Szukaj...">
...
<div class="title"> <h3>Wyniki wyszukiwania</h3></div>
    ...
    @foreach($books as $book)
            <tr>
                ...
                <td><a href="{{ route('edit',$book) }}" class="btn btn-success btn-xs" title="Zarezerwuj"> Zarezerwuj </a></td>
            </tr>       
    @endforeach
    </tbody>
    </table> 
